...
const contractABI = require("../artifacts/contracts/Solanaforge.sol/Solanaforge.json").abi;

program
    .name("solanaforge-cli")
    .description("CLI tool for Solanaforge smart contract")
    .version("1.0.0");
